...
export default class ChartExtractor extends React.Component<ChartExtractorProps, ChartExtractorState> {
    ...
    render(): JSX.Element {
        ...
        const layout = [
            { i: 'menuBar', x: 0, y: 0, w: 24, h: 1, static: true },
            { i: 'newChart', x: 0, y: 1, w: 8, h: chartViewHeightUnits },
            { i: 'chartView', x: 8, y: 1, w: 9, h: chartViewHeightUnits },
            { i: 'axisTableX', x: 17, y: 1, w: 6, h: 3 },
            { i: 'axisTableY', x: 17, y: 4, w: 6, h: 3 },
            { i: 'dataTable', x: 17, y: 6, w: 6, h: 8 },
            { i: 'statusBar', x: 0, y: chartViewHeightUnits + 1, w: 24, h: 1, static: true },
        ];
